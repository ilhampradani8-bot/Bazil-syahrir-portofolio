const translations = {
    en: {
        // GLOBAL
        logo_sub: "Wealth Mgmt",

        // NAVBAR
        nav_about: "About",
        nav_services: "Services",
        nav_achieve: "Achievements",
        nav_contact: "Contact",
        nav_cta: "Free Consultation",

        // HERO SECTION
        hero_headline: "Shariah Registered Financial Planner & Senior Wealth Planner",
        hero_sub: "Helping you plan finances, investments, and inheritance the Shariah way.",
        btn_cta: "Contact Me",

        // LICENSES
        lic_title: "Licenses & Credentials",
        lic_1_title: "Securities Commission",
        lic_1_sub: "(FPR)",
        lic_2_title: "Bank Negara Malaysia",
        lic_2_sub: "(iFAR)",
        lic_3_title: "FIMM",
        lic_3_sub: "Unit Trust & PRS",
        lic_4_title: "IBFIM/MTA",
        lic_4_sub: "Takaful",
        lic_5_title: "As-Salihin Trustee",
        lic_5_sub: "& MyPusaka",

        // ABOUT
        about_title: "Professional Profile",
        about_tagline: "Dedicated to Shariah-compliant wealth management.",
        about_head: "My Background",
        about_desc: "I am a Bachelor of Science (Hons) graduate from UiTM Shah Alam with extensive experience in the financial industry. Currently serving as a Senior Wealth Planner at Phillip Wealth Planners and Premier Advisor at The Sophisticated Investor Group (TSI). My mission is to help individuals and families achieve financial freedom through ethical and Shariah-compliant planning.",
        about_badge_1: "UiTM Graduate",
        about_badge_2: "7+ Years Exp",
    ...
    bm: {
        ...
        nav_contact: "Hubungi",
        nav_cta: "Konsultasi Percuma",

        // HERO SECTION
        hero_headline: "Perancang Kewangan Berdaftar Syariah & Perancang Kekayaan Kanan",
        hero_sub: "Membantu anda merancang kewangan, pelaburan, dan pewarisan secara Syariah.",
        btn_cta: "Hubungi Saya",

        // LICENSES
        lic_title: "Lisensi & Kualifikasi",
        lic_1_title: "Suruhanjaya Sekuriti",
        lic_1_sub: "(FPR)",
        lic_2_title: "Bank Negara Malaysia",
        lic_2_sub: "(iFAR)",
        lic_3_title: "FIMM",
        lic_3_sub: "Unit Amanah & PRS",
        lic_4_title: "IBFIM/MTA",
        lic_4_sub: "Takaful",
        lic_5_title: "As-Salihin Trustee",
        lic_5_sub: "& MyPusaka",
        ...
        about_tagline: "Berdedikasi untuk pengurusan kekayaan patuh Syariah.",
        about_head: "Latar Belakang Saya",
        about_desc: "Saya adalah graduan Ijazah Sarjana Muda Sains (Kepujian) dari UiTM Shah Alam dengan pengalaman luas dalam industri kewangan. Kini berkhidmat sebagai Perancang Kekayaan Kanan di Phillip Wealth Planners dan Penasihat Premier di The Sophisticated Investor Group (TSI). Misi saya adalah membantu individu dan keluarga mencapai kebebasan kewangan melalui perancangan yang etikal dan patuh Syariah.",
        about_badge_1: "Graduan UiTM",
        about_badge_2: "Pengalaman 7+ Thn",
